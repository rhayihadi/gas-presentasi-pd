...
// WAJIB ADA: filter by NIS dulu
$where = "WHERE tb_aspirasi.nis = '$nis'";
...
<input type="month" name="bulan" class="tanggal" value="<?= $bulan ?>" onchange="this.form.submit()"><br>
</form>
</div>
...
<div class="btn-area">
<a href="dashboard-siswa.php"><button class="btn">Kembali</button></a>
</div>
